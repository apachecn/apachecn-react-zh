...
*   `onRemoveAllTweetsFromCollection`属性引用一个函数，该函数从我们的集合中删除所有 tweet。此功能在`Application`组件中实现，并在[第 5 章](05.html "Chapter 5. Making Your React Components Reactive")中讨论，*使您的React组件反应*。
