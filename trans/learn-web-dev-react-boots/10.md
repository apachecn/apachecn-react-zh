...
![How React will help to split your code in lazy loading](graphics/B05743_10_07-1.jpg)
...
![Bootstrap content - typography](graphics/image_10_002.jpg)

现在的问题是：如何在我的系统中使用这种字体？我应该下载吗？或者出路是什么？有一个非常简单的方法，正如我们在前面的截图中看到的；同一个对话框有一个名为**嵌入**的选项卡。

![Bootstrap content - typography](graphics/image_10_003.jpg)

单击该按钮时，将显示以下屏幕：

![Bootstrap content - typography](graphics/image_10_004.jpg)
...
![Bootstrap component - button](graphics/image_10_005.jpg)
...
![Bootstrap component - button](graphics/B05743_10_05-2.jpg)
...
![Bootstrap responsive grid system](graphics/image_10_007.jpg)

以下屏幕截图显示了 mobile、tablet 和 desktop 列的设置：

![Bootstrap responsive grid system](graphics/image_10_008.jpg)
