...
1.  Download the installer for your operating system from [http://nodejs.org/](http://nodejs.org/). Node.js provides different installers in line with your platform. In this chapter, we will use the Windows installer to set up Node.
    ...
    ![Installing Node and npm](graphics/image_09_001.jpg)
...
3.  Run the installer and the MSI file that we downloaded.
    ...
    ![Installing Node and npm](graphics/image_09_002.jpg)
...
![Installing modules](graphics/image_09_003.jpg)
...
![Responsive Bootstrap application with React and Node](graphics/B05743_09_03-1.jpg)

服务器在 webpack 中启动，以将代码包构建到服务器客户端浏览器。如果一切顺利，您可以在构建完成后获得以下信息：

![Responsive Bootstrap application with React and Node](graphics/image_09_005.jpg)
...
![Responsive Bootstrap application with React and Node](graphics/image_09_006.jpg)
...
![Responsive Bootstrap application with React and Node](graphics/image_09_007.jpg)

看起来不错。现在，让我们填写此表单，提交并查看输出：

![Responsive Bootstrap application with React and Node](graphics/image_09_008.jpg)
...
![Responsive Bootstrap application with React and Node](graphics/image_09_009.jpg)
...
![Bootstrap responsive tables](graphics/image_09_010.jpg)

如果您尚未提交任何票据，您将在 UI 中收到相应的消息（**您尚未提交任何票据。**）。

好的，让我们提交新的票证并再次打开此页面。添加票证后，它将显示在您的表中：

![Bootstrap responsive tables](graphics/image_09_012.jpg)
...
![How to use](graphics/image_09_013.jpg)

在侧面板中，您可以看到每个反应组件的**状态**和**道具**。如果展开组件的**状态**，您将看到组件的完整层次结构以及您在 React 应用程序中使用的组件的名称。

请参见以下屏幕截图：

![How to use](graphics/image_09_014.jpg)

右键单击侧面板，我们可以在右侧面板中检查和编辑其当前道具和状态。

我们也可以点击**执行功能**查看代码执行功能：

![How to use](graphics/image_09_015.jpg)

如果您使用 React 工具检查`allTicket`组件，您可以看到`props`进入子元素的数据流：

![How to use](graphics/image_09_016.jpg)

如果您在**元素**选项卡中检查页面上的某个反应元素，然后切换到**反应**选项卡，则该元素将在反应树中自动选择。使用“搜索”选项卡，我们还可以按名称搜索组件。
