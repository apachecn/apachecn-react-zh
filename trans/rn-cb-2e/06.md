...
我们将在这个配方中使用一个云的 PNG 图像。您可以在 GitHub 上托管的配方存储库中的[中找到该图像 https://github.com/warlyware/react-native-cookbook/tree/master/chapter-6/simple-animation/img/images](https://github.com/warlyware/react-native-cookbook/tree/master/chapter-6/simple-animation/img/images) 。将图像放入`/img/images`文件夹中，以便在应用程序中使用。
