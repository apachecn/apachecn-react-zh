...
在“审核”选项卡中，除了 Lighthouse PWA 审核之外，还包括一系列其他基准测试，包括性能和 web 最佳实践。我们将重点关注 PWA 测试和性能测试，但也可以随意运行其他测试。
...
在这里，我们的目标是在运行`yarn deploy`时在应用程序上运行 Lighthouse。为此，我们必须制作一个自定义部署脚本。
